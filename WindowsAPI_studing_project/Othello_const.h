//----------Windows sizes, initial position & limits---------
...
#define UD_MAX_POS		    26
#define UD_MIN_POS		    4
#define UD_SET_POS		    8

#define BOARD_COLOR			RGB(0x60, 0xA0, 0xB0)
#define HIGHLIGHT_COLOR		RGB(0xA0, 0xD0, 0xE0)
#define WHITE               RGB(0xFF, 0xFF, 0xFF)
#define BLACK               RGB(0x00, 0x00, 0x00) 
#define SOFT_WHITE          RGB(0xE0, 0xE0, 0xE0)
#define SOFT_BLACK          RGB(0x20, 0x20, 0x20) 